...
@pytest.fixture(params= [ # Корректные номера счетов
    ("12345678901234567890", "**7890"),
    ("00000000000000000000", "**0000"),
    ("99999999999999999999", "**9999"),

    # Некорректные номера - должны вызывать ошибку
    ("123", "Введите номер счёта, он включает в себя только цифры"),  # слишком короткий
    ("", "Введите номер счёта, он включает в себя только цифры"),  # пустая строка
    ("abcdefghijklmnopqrst", "Введите номер счёта, он включает в себя только цифры"),  # буквы
    ("1234567890123456789", "Введите номер счёта, он включает в себя только цифры"),  # 19 цифр
    ("123456789012345678901", "Введите номер счёта, он включает в себя только цифры"),  # 21 цифра
    ("12345 67890 12345 67890", "Введите номер счёта, он включает в себя только цифры"),  # с пробелами
    ("1234567890abcdefghij", "Введите номер счёта, он включает в себя только цифры")  # цифры и буквы
])
